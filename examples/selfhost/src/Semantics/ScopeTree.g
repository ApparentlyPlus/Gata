 ...
 *
 * TODO(Mangler.g): this is Mangler.Hash. It lives here because ScopeTree is what needs it first
 * and Backend/Mangler.g is not ported; when it lands, it must call this one rather than grow a
 * second copy - a scope token that disagreed with the mangler's would split one name in two.
 */
