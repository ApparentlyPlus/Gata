...
import "selfhostlib/Int.g"; // Int.ToString backs the `as String` operator below
import "selfhostlib/Long.g"; // Long.ToString backs `int64 as String`
import "selfhostlib/Format.g"; // Format.Double backs `v as String` for double
