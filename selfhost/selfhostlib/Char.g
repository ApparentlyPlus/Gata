...
module Char {
    ...
    /*
     * HexValue - Numeric value of a hex digit, 0..15, or -1 if c is not one. The companion to
     * IsHexDigit: without it the only way to read a hex digit's value is DigitValue, which
